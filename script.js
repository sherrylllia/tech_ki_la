    ...
    igProfile: {
      ...
      posts: [
        ...
        { id: 6, title: '定義演變：從人際連結到內容競技場', author: '中井穗月', images: ['project2/社群演變/演變-1.png', 'project2/社群演變/演變-2.png', 'project2/社群演變/演變-3.png', 'project2/社群演變/演變-4.png', 'project2/社群演變/演變-5.png'], 
          caption: `
          不是網紅業配，不是某個你根本不認識的帳號在吵架，也不是第八十七則AI生成的「10個讓你成功的習慣」——而是你真的認識的人，隨手分享的一個生活片刻。想了一下才想起來？別擔心，這不是你的問題。是社群媒體，偷偷地變了一個人。

          ▌從聚會場所到內容競技場

                2000年代，社群媒體的邏輯很單純。Facebook是一個讓你知道朋友近況的地方——派對在哪裡舉辦、誰換了一份新工作。Instagram是朋友分享旅行照片和午餐的地方。這些平台的核心價值，是「人與人之間的連結」，名字裡的「社群」，名副其實。
          然而過去十年間，這個核心悄悄被替換掉了。如今打開任何一個社群平台，映入眼簾的是名人精心製作的宣傳影片、針對每一則新聞事件高聲表態的評論者、從流行文化剪輯出的短影音，以及急速蔓延、難以辨別真偽的AI生成內容。

                這樣的轉變不只是感受，數據也清楚地指向同一個方向。Meta自己揭露的內部數據顯示，在過去兩年間，用戶在Facebook上瀏覽「朋友所發布內容」的時間佔比，從22%下滑至17%；Instagram上的比例更從11%跌至7%。換句話說，你在Instagram上花的時間裡，超過九成看的根本不是朋友的內容。平台的演算法早已決定：陌生人製作的高互動內容，遠比朋友的日常動態更值得被推送。這不是用戶的選擇，而是平台設計的結果。

          ▌朋友輸給了演算法

                社群媒體的收入來源是廣告，廣告的效益取決於用戶停留時間，而停留時間的長短，則由演算法決定推送什麼內容。名人影片、爭議評論、高度刺激的短影音，這些內容比朋友的普通日常更能抓住眼球、延長停留。於是演算法不斷學習、不斷優化，最終把平台推向了一個對商業最有利、卻對「社群」最不友善的方向。朋友的日常，在這場流量競賽中，輸了。

          ▌我們失去的是什麼？

                也許有人覺得，現在的社群媒體也挺好的，資訊很豐富、娛樂很夠用。但有時候還是會有點悵然。是那種知道朋友正在經歷什麼的親近感，是那種即使沒有見面、也感覺彼此存在於同一個世界的連結。這些細微的情感紐帶，曾經是社群媒體最有價值的東西。如今它們被演算法判定為「低互動內容」，慢慢地從版面上消失。社群媒體沒有消失，它只是換了一張臉。從一個讓人與人相遇的廣場，變成了一座讓內容彼此競爭的競技場。而我們，在不知不覺間，從主角變成了觀眾。` },

        { id: 7, title: '數據壟斷下的鄉愁：演算法如何「取消」我們的未來？', author: '劉佳琪', images: ['project2/演算法與品味文化/演算法與品味-1.png', 'project2/演算法與品味文化/演算法與品味-2.png', 'project2/演算法與品味文化/演算法與品味-3.png', 'project2/演算法與品味文化/演算法與品味-4.png', 'project2/演算法與品味文化/演算法與品味-5.png'], 
          caption: `
